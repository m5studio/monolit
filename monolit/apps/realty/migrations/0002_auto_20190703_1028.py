    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_type', models.CharField(choices=[('flat', 'Квартира'), ('apartments', 'Апартаменты'), ('commercial', 'Коммерческое помещение')], max_length=100, verbose_name='Тип помещения')),
                ...
                ('price_per_square', models.DecimalField(blank=True, decimal_places=2, help_text='Стоимость одного квадратного метра', max_digits=10, null=True, verbose_name='Цена за м2 (руб.)')),
                ('price_total', models.DecimalField(blank=True, decimal_places=2, help_text='Считается автоматически из Площади помещения * Цена за м2', max_digits=10, null=True, verbose_name='Общая стоимость (руб.)')),
                ...
                ('ceiling_height', models.DecimalField(blank=True, decimal_places=2, help_text='Пример: 2.30 = 2 метра 30 см', max_digits=10, null=True, verbose_name='Высота потолка (м)')),
