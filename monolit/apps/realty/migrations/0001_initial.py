    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.CharField(blank=True, help_text='e.g.: если название "Жилой квартал", то здесь заполняется как "living-quarter"', max_length=100, null=True, unique=True, verbose_name='Тип объекта (eng)')),
            ],
            options={
