...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='object',
            name='crm_id',
            field=models.CharField(default=0, help_text='ID объекта в 1C (Заполняется автоматически при выгрузке)', max_length=100, unique=True, verbose_name='CRM ID'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crm_id', models.CharField(blank=True, help_text='ID объекта в 1C (Заполняется автоматически при выгрузке)', max_length=100, null=True, unique=True, verbose_name='CRM ID')),
