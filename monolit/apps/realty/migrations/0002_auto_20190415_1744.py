    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_type', models.CharField(blank=True, choices=[('flat', 'Квартира'), ('apartments', 'Апартаменты'), ('commercial', 'Коммерческое')], max_length=100, null=True, verbose_name='Тип помещения')),
                ...
                ('window_view', multiselectfield.db.fields.MultiSelectField(blank=True, choices=[('yard', 'Во двор'), ('street', 'Улица'), ('sea', 'Море'), ('lake', 'Озеро'), ('mountains', 'Горы')], max_length=30, null=True, verbose_name='Вид из окон')),
                ...
                ('updated', models.DateTimeField(auto_now=True, null=True)),
                ('object', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='realty.Object', verbose_name='Объект')),
