# Generated by Django 2.2.3 on 2019-07-10 09:42
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('military', models.ManyToManyField(blank=True, help_text='Выберите Объекты подходящие под военную ипотеку', related_name='mortgage_object_military', to='realty.Object', verbose_name='Объект(ы) под Военную ипотеку')),
                ('mother', models.ManyToManyField(blank=True, help_text='Выберите Объекты подходящие под материнский капитал', related_name='mortgage_object_mother', to='realty.Object', verbose_name='Объект(ы) под Материнский капитал')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='offer',
            name='object',
            field=models.ManyToManyField(blank=True, help_text='Выберите Объекты подходящие под данную ипотечную программу', to='realty.Object', verbose_name='Объект(ы)'),
        ),
    ]
